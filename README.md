...
Resource could be a file like an image, a html file, an endpoint

- [ ] What can the API return to help clients know if a request was successful?
HTTP status codes are made just for the purpose of describing at a glance what the result is of a request. There is a 200 code to signify a successful. You have 404s for telling the browser a resource wasn't found. You have 500 errors to signify a server issue, and you have a 403 code to tell the browser it isn't authorized.
